...
public class StatusBarFooterHandle extends NodeHandle<Node> {
    ...
    /**
     * Returns true if the current content of the sync status is different from the moduleCode remembered by the most recent
    ...
    /**
     * Returns true if the current content of the 'save location' is different from the moduleCode remembered by the most
