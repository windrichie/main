...
public class ArgumentTokenizerTest {
     ...
     * and only the last moduleCode is returned upon calling {@code ArgumentMultimap#getValue(Prefix)}.
     */
    private void assertArgumentPresent(ArgumentMultimap argMultimap, Prefix prefix, String... expectedValues) {

        // Verify the last moduleCode is returned
    ...
    public void tokenize_oneArgument() {
        // Preamble present
        String argsString = "  Some preamble string p/ Argument moduleCode ";
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(argsString, pSlash);
        assertPreamblePresent(argMultimap, "Some preamble string");
        assertArgumentPresent(argMultimap, pSlash, "Argument moduleCode");

        // No preamble
        argsString = " p/   Argument moduleCode ";
    ...
    public void tokenize_multipleArguments() {
        ...
        String argsString = "SomePreambleString -t dashT-Value p/pSlash moduleCode";
        ...
        argsString = "Different Preamble String ^Q111 -t dashT-Value p/pSlash moduleCode";
        ...
        argsString = unknownPrefix + "some moduleCode";
        argMultimap = ArgumentTokenizer.tokenize(argsString, pSlash, dashT, hatQ);
    ...
    public void tokenize_multipleArgumentsWithRepeats() {
        ...
        assertPreamblePresent(argMultimap, "SomePreambleString");
        assertArgumentPresent(argMultimap, pSlash, "pSlash moduleCode");
        assertArgumentPresent(argMultimap, dashT, "dashT-Value", "another dashT moduleCode", "");
