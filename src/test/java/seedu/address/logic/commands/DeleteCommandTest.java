...
public class DeleteCommandTest {
    ...
    private Model model = new ModelManager(getTypicalAddressBook(), new UserPrefs(), new EventCalendar());
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        ModelManager expectedModel = new ModelManager(model.getAddressBook(), new UserPrefs(), new EventCalendar());
    ...
    public void execute_validIndexFilteredList_success() {
        ...
        Model expectedModel = new ModelManager(model.getAddressBook(), new UserPrefs(), new EventCalendar());
        expectedModel.deletePerson(personToDelete);
        expectedModel.commitAddressBook();
