...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        ...
        EventCalendarStorage eventCalendarStorage = new JsonEventCalendarStorage(userPrefs.getEventCalendarFilePath());
        storage = new StorageManager(addressBookStorage, userPrefsStorage, eventCalendarStorage);
